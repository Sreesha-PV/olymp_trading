...
//   final String registerUrl = "https://bo.zebacus.com/backend/api/v1/client/account/register";
//   final String loginUrl = "https://bo.zebacus.com/backend/api/v1/client/auth/login";
...
class AuthService with ChangeNotifier {
  ...
  // final String loginUrl = "http://192.168.4.30:8080/api/v1/client/auth/login";
    ...
    //  final String registerUrl = 'https://bo.zebacus.com/backend/api/v1/client/auth/register';
    //  final String loginUrl = 'https://bo.zebacus.com/backend/api/v1/client/auth/login';
  ...
  try {
    ...
    if (response.statusCode == 200 && responseBody.containsKey('token')) {
      ...
      // Handle errors better from response
      String errorMessage = "Login failed";
      if (responseBody is Map &&
          responseBody['data'] != null &&
          responseBody['data']['errors'] != null &&
