...
//       int remainingTime = startDuration - tick - 1;
//       if (remainingTime <= 0) {
//         // socketProvider._moveOrderToHistory(order);
//         _showTradeExpiredDialog(context); 
//       }
//       return remainingTime < 0 ? 0 : remainingTime;
//     });
...
//       child: Consumer<TradeSocketProvider>(
//         builder: (context, socketProvider, _) {
//         // builder: (context, activeOrderProvider, socketProvider, child) {
...
//   Widget _buildActiveTradesSection(TradeSocketProvider socketProvider, BuildContext context) {
//     return Column(
//       children: [
//         const Padding(
//           padding: EdgeInsets.all(10),
...
//   List<Widget> _buildActiveOrdersList(TradeSocketProvider socketProvider, BuildContext context) {
...
//                       StreamBuilder<int>(
//                       stream: _timerStream(order.orderDuration! * 60, order,socketProvider, context),
//                       // stream: _timerStream(order.orderDuration! * 60, order,activeOrderProvider,socketProvider, context),
...
// print('[UI] Rendering TradeHistory - Profit: ${trade.profit}, Loss: ${trade.loss}');
