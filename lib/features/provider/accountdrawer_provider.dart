...
class TradeSocketProvider with ChangeNotifier {
  ...
  // Initialize WebSocket and listen for updates
  TradeSocketProvider() {
    _connectWebSocket();
  }

  // Fetch active orders (initial loading if needed)
  ...
  // Move an order to the history when it's completed or expired
