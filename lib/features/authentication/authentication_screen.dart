...
class AuthScreen extends StatelessWidget {
  ...
  Widget _buildToggleButtons(AuthProvider authProvider) {
    return Container(
      ...
      child: Row(
        children: [
          _buildToggleButton(
              "Login", !authProvider.isRegistering, authProvider),
          _buildToggleButton(
              "Register", authProvider.isRegistering, authProvider),
        ],
      ),
    );
  }
  ...
  Widget _buildPasswordField(
      TextEditingController controller, ValueNotifier<bool> isPasswordVisible) {
