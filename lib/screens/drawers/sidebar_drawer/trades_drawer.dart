...
//           Padding(padding: const EdgeInsets.only(left: 14,top: 15),
//           child: Row(
//             children: [
//               const Text('Trades',
//               style: TextStyle(
    ...
    return Drawer(
      ...
      child: Column(
        children: [
          ...
          const Flexible(  // Use Flexible instead of Expanded
            child: DefaultTabController(
              length: 3,
              child: Column(
                children: [
                  ...
                  Flexible( // Wrap TabBarView inside Flexible to prevent overflow
                    child: TabBarView(
                      children: [
                        FixedtimePage(),
                        ForexPage(),
